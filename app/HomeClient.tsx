...
function HomeContent({ initialReports }: { initialReports: Report[] }) {
  ...
  useEffect(() => {
    sessionStorage.setItem('reportsData', JSON.stringify(initialReports))
  }, [initialReports])
...
export default function HomeClient({ initialReports }: { initialReports: Report[] }) {
  return (
    <Suspense fallback={<div>Loading...</div>}>
      <HomeContent initialReports={initialReports} />
    </Suspense>
  )
}
